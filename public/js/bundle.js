      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', "".concat(type.toUpperCase(), " updated successfully!")); //refresh page to display the image immediately without refreshing the page manually
...
var stripe = Stripe('pk_test_hXO0uvMuhxd8tM2Eo9T175AU00k6cccWCw');
